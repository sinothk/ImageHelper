...
import com.sinothk.helper.image.utils.compress.tiny.common.TinyException;
import com.sinothk.helper.image.utils.compress.tiny.common.UriUtil;
import com.sinothk.helper.image.utils.compress.tiny.core.BitmapCompressor;
import com.sinothk.helper.image.utils.compress.tiny.core.CompressKit;
import com.sinothk.helper.image.utils.compress.tiny.core.FileCompressor;
...
public class FileCompressCallableTasks {
    ...
    public static final class ResourceAsFileCallable extends BaseFileCompressCallable {
        ...
        @Override
        public CompressResult call() throws Exception {
            Bitmap bitmap = BitmapCompressor.compress(mResId, mCompressOptions, false);
            return FileCompressor.compress(bitmap, mCompressOptions, shouldReturnBitmap, true);
        }
    }
    ...
    public static final class ResourceArrayAsFileCallable extends BaseFileBatchCompressCallable {
        ...
        public BatchCompressResult call() throws Exception {
            ...
            for (int i = 0; i < mResIds.length; i++) {
                Bitmap bitmap = BitmapCompressor.compress(mResIds[i], mCompressOptions, false);
